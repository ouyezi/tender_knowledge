...
1. `tender_skills` 已安装且通过测试（已验证 commit: `eb71dfea390676cbfbe0fc2da31ff299218f92d1`）：
...
DOC_CHUNK_PROMOTE_HEADINGS=auto   # 默认 auto，识别「二、」等大章
...
# 样例 docx 无表格，需手动合并 tables/ 侧车与 slice 文件（见 tests/fixtures 现有 t0000.*）
```
